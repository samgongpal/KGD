...
<%@ include file="topmenu.jsp" %>
  <section>
    <form name="check_Join" onsubmit="return checkAll()" action="userJoinPro.jsp" method="post">
    <table>
      <input type="hidden" name="u_no" value=<%= max_no%>>
      <tr><th>아이디 : </th><td><input type="text" name="u_id"></td>
      </tr>
      
      <tr><th>비밀번호 : </th><td><input type="password" name="u_pw"></td>
      </tr>
      ...
      %>
      <tr><th>가입일 : </th><td><input type="text" name="u_regdate" value="<%= strdate%>" readonly="readonly"></td>
      </tr>
