...
<%
  ...
  try{
	 ...
	 String sql = "SELECT M.m_name, T.t_address, R.r_count ";
	         sql+= "FROM MOVIE M, THEATER T, RESERVATION R WHERE r.u_no = 4 AND R.t_no = T.t_no AND r.m_no = M.m_no"; 
